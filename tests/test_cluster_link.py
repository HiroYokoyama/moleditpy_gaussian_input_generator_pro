...
package: gaussian_input_generator_pro/__init__.py imports PyQt6, and CI installs pytest only. The module
...
class TestSubmitToCluster(unittest.TestCase):
    def setUp(self):
        ...
        self.path = os.path.join(self.tmp, "mol.gjf")
